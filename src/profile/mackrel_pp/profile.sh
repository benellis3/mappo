...
python3 -m cProfile -o $P/subprocessX.out ${REL_PATH}main.py --exp_name="mackrel_pp" with t_max=30000 batch_size=${N_ITER} batch_size_run=${N_ITER} runner_test_batch_size=${N_ITER}
