...
python3 -m cProfile -o $P/subprocessX.out ${REL_PATH}main.py --exp_name="mackrel_pp" with t_max=10000 batch_size=${N_ITER} batch_size_run=${N_ITER} runner_test_batch_size=${N_ITER} n_loops_per_thread_or_sub_or_main_process=1 n_subprocesses=${N_ITER}
