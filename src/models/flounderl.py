...
class FLOUNDERLQFunctionLevel2(nn.Module):
    ...
    def __init__(self, input_shapes, output_shapes={}, layer_args={}, n_actions=None, args=None):
        ...
        super(FLOUNDERLQFunctionLevel2, self).__init__()
...
class FLOUNDERLQFunctionLevel3(nn.Module):
    # modelled after https://github.com/oxwhirl/hardercomns/blob/master/code/model/StarCraftMicro.lua 5e00920

    def __init__(self, input_shapes, output_shapes={}, layer_args={}, n_actions=None, args=None):

        super(FLOUNDERLQFunctionLevel3, self).__init__()
...
class FLOUNDERLCritic(nn.Module):
    ...
    def __init__(self, input_shapes, n_actions, n_agents, output_shapes={}, layer_args={}, args=None):
        ...
        self.FLOUNDERLQFunction = FLOUNDERLQFunctionLevel1(input_shapes={"main":self.input_shapes["qfunction"]},
                                               output_shapes={},
...
class FLOUNDERLAgent(nn.Module):
    ...
    def forward(self, inputs, hidden_states, tformat, loss_fn=None, **kwargs):
        ...
        # forward through pair probability modules


        # forward through final fuser module
