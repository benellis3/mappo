...
class XXXQFunction(nn.Module):
    ...
    def __init__(self, input_shapes, output_shapes={}, layer_args={}, n_actions=None, args=None):
        ...
        super(XXXQFunction, self).__init__()
...
class XXXCritic(nn.Module):
    ...
    def __init__(self, input_shapes, n_actions, output_shapes={}, layer_args={}, args=None):
        ...
        self.XXXQFunction = XXXQFunction(input_shapes={"main":self.input_shapes["qfunction"]},
                                           output_shapes={},
...
class XXXNonRecursiveAgent(NonRecursiveAgent):
...
class XXXRecursiveAgent(RecursiveAgent):
