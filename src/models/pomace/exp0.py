...
class poMACEExp0NoiseNetwork(nn.Module):  # Mainly copied from poMACENoiseNetwork
    def __init__(self, input_shapes, output_shapes=None, layer_args=None, n_agents=None, n_actions=None, args=None):

        super(poMACEExp0NoiseNetwork, self).__init__()
...
class poMACEExp0Network(nn.Module):
    def __init__(self,
        ...
        super(poMACEExp0Network, self).__init__()
        ...
        self.encoder = pomaceExp0AgentMLPEncoder(input_shapes=dict(main=self.layer_args["fc1"]["in"]),
...
class pomaceExp0AgentMLPEncoder(nn.Module):
    def __init__(self, input_shapes, output_shapes=None, layer_args=None, args=None):
        super(pomaceExp0AgentMLPEncoder, self).__init__()
        self.args = args
