...
class BIQLMultiagentController():
    """
    ...
    def __init__(self, runner, n_agents, n_actions, action_selector=None, args=None):
        ...
        assert self.args.agent_output_type in ["qvalues"], "agent_output_type has to be set to 'qvalues' for BIQL - makes no sense with other methods!"
        ...
        self.pairwise_Q_scheme =   Scheme([dict(name="pomace_epsilons",
                                                scope="episode",
                                                requires_grad=False,
