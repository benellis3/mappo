...
class VDNMultiagentController():
    ...
    def __init__(self, runner, n_agents, n_actions, action_selector=None, args=None, **kwargs):
        ...
        assert self.args.agent_output_type in ["qvalues"], "agent_output_type has to be set to 'qvalues' for VDN - makes no sense with other methods!"
        ...
        self.mixer_scheme =   Scheme([dict(name="state",
                                           switch=self.args.vdn_use_state)])
