...
maps = {
    "micro_corridor" : {"qmix" : "qmix__micro_corridor__2018-11-14_10-29-41",
                        "iql": "iql__micro_corridor__2018"},
    ...
    "3s_vs_3z": {"qmix": "qmix__3s_vs_3z__2018-11-14_04-39-31",
    ...
    "micro_2M_Z": {"iql": "iql__micro_2M_Z__2018-11-14_11-09-31",
                   ...
                   "qmix": "qmix_parallel_micro1__2018-10-19_10-39-33"},
    ...
    "micro_retarget" : {"qmix": "qmix__micro_retarget__2018-11-14_09-19-34",
...
dir_prefix = "/Users/mika/Downloads/models"
...
for i, map_name in enumerate(maps.keys()):
    ...
    for method, path in experiment.items():
        ...
        command = "python3 src/main.py --config={} --env-config=sc2 with env_args.map_name={} checkpoint_path={} load_step={} evaluate=True save_replay=True test_nepisode={} env_args.save_replay_prefix={}".format(
            method,
            map_name,
            checkpoint_path,
            load_step,
